...
KNOWN_COLORS = {
    ...
    # [Ni(dmg)2] — ЭТО буквально точка из обучающих 93 комплексов
    # (450 нм, "red" по Miessler & Tarr), но инференс модели давал
    # DEEP YELLOW — модельная ошибка регрессии даже на своей же
    # обучающей точке. Подстраховка до переобучения модели.
    ('Ni', 2, 'dmg', 'square_planar'): ('#B22222', '#2ECC40', 'red'),
}
